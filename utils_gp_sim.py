...
def get_workspace_vis(predictions,
    ...
    prediction_vis = (prediction_vis-min_val)/(max_val-min_val) # Globally normalized.
...
def get_grasp_vis(predictions,
    ...
    for canvas_row in range(4):
        ...
        for canvas_col in range(int(num_rotations / 4)):
            ...
            prediction_vis = get_workspace_vis(predictions=prediction,
...
def get_heightmap(robot,
    ...
    return color_img_set, depth_img_set, color_heightmap, valid_depth_heightmap
